...
Physical Curve("inlet") = {13,14,15,16};
Physical Curve("outlet") = {5, 6, 7, 8};
Physical Curve("walls") = {1, 2, 3, 4, 9, 10, 11, 12};
Physical Curve("cylinder") = {45, 46, 47, 48, 49, 50, 51, 52};
Physical Surface("My surface") = {54,56,58,60,62,64,66,68,70,72,74,76,78,80,82,84,86,88,90,92};
Mesh 2;
